...
// Código criado para avisar através de um bip temperaturas do ar acima de 27 °C
// Componentes: Arduino Uno, sensor DHT 11, display LCD 16x2 acoplado com um módulo I2C no endereço 0x27, Buzzer
// Criado inicialmente para apitar quando a temperatura de uma caixa aquecida de kefir de água atingir valores de 27°C ou mais
// Implementações futuras: conectar um relé para controlar o acender e apagar do aquecedor (lâmpada incandescente)
